...
function yearChart_m(ct_m, res){
   ...
   if(res != 'undefined' && res != null) {
	   lb = '단위 : 억';
	   //시연용 데이터
			year[0] = 2022, year[1] = 2021, year[2] = 2020, year[3] = 2019, year[4] =2018;
			cnt[0] = 2,415,333,500, cnt[1] = 4,975,836,000, cnt[2] = 5,015,333,500, cnt[3] = 3,415,803,600, cnt[4] = 3,915,333,200; 
...
// 			}
	  //시연용 데이터
		   year[0] = 2022, year[1] = 2021, year[2] = 2020, year[3] = 2019, year[4] =2018;
		   cnt[0] = 3565, cnt[1] = 7544, cnt[2] = 6987, cnt[3] = 9002, cnt[4] = 8451; 
	   }
